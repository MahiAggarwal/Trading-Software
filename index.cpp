...
// Class for binding all account details together
class Account {
	...
	{
		int option;
		cout << "press 1 to buy dogecoin else 2 to buy bitcoin\n";
		cin >> option;
	...
	{
		int option;
		cout << "press 1 to sell dogecoin else 2 to sell bitcoin\n";
		cin >> option;
	...
	void History()
	{
		...
		char temp;
		cout << "Do you want to clear all transactions?? Enter Y for yes or any other invalid key for no.";
		cin >> temp;
...
int main()
{
	...
	cout<<"MADE BY: MAHI AGGARWAL\n"<<endl;
	while (1) {
        cout << endl;
		cout << "Press 1 if you want to have your Account Info "
			<< endl;
		cout << "Press 2 if you want to Deposit your money "
			<< endl;
		cout << "Press 3 if you want to withdraw your money "
			<< endl;
		cout << "Press 4 if you want to know your history "
			<< endl;
		cout << "Press 5 if you want to Buy Crypto "
			<< endl;
		cout << "Press 6 if you want to Sell Crypto "
			<< endl;
